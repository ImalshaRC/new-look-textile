            ...
            <form onSubmit={e => onSubmit(e)}>
                ...
                <table class="driver-table">
                    ...
                    <tr>
                        <td>
                            Outlet ID
                            <input type="text" name="outletIDOrder" value={outletID} placeholder="Enter Your E-mail"/>
                        </td>
                    </tr><br/><br/>
                    <tr>
                        <td>
                            Design Code
                            <input type="text" name="designCode" value={designCode} placeholder="Enter Your city" onChange={ e => onInputChange(e)}/>
                        </td>
                        <td className="tb-right">
                            Product Name
                            <input type="text" name="productName" value={productName} placeholder="Enter Street Address" onChange={ e => onInputChange(e)}/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            Date
                            <input type="text" name="OrderDate" value={OrderDate} placeholder="Enter Your Posatal Code" onChange={ e => onInputChange(e)}/>
                        </td>
                        <td className="tb-right">                            
                            Category
                            <input type="text" name="category" value={category} placeholder="Enter Your Posatal Code" onChange={ e => onInputChange(e)}/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            size
                            <input type="text" name="size" value={size} placeholder="Enter Your Posatal Code" onChange={ e => onInputChange(e)}/>
                        </td>
                        <td className="tb-right">                            
                            Quantity
                            <input type="text" name="quantity" value={quantity} placeholder="Enter Your Posatal Code" onChange={ e => onInputChange(e)}/>
                        </td>
                    </tr>
