...
export default function UpdateOutlet() {
    ...
    const { ownerName, NIC, outletName, ownerAddress, ownerPhone, date, email, password, userID, outletPhone } = outlet;
    ...
    const onSubmit = async e => {
        e.preventDefault();
        await axios.post('http://localhost:5000/outlet/update/' + id, outlet).then(() => {
            ...
            <form onSubmit={e => onSubmit(e)}>
                ...
                <table class="payment-table">
                    ...
                    <tr>
                        <td>
                            User ID
                            <input type="text" name="userID" value={userID} placeholder="Enter Date" onChange={ e => onInputChange(e)}/><br/>
                        </td>
                    </tr>
                    <tr>
                        <td>
